...
use App\Notifications\Backend\Auth\BrokerRegistered;
...
class RegisterController extends Controller
{
    ...
    public function register(RegisterRequest $request)
    {
        ...
        $user = $this->userRepository->create($request->only('first_name', 'last_name', 'email', 'phone_no', 'mobile_no', 'password'));
