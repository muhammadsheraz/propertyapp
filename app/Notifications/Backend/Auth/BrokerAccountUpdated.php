 ...
 */
class BrokerAccountUpdated extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->subject(app_name() . ' - ' . __('strings.emails.subject.account_updated'))
            ->greeting('Dear ' . $notifiable->full_name . ',')
            ->line(__('strings.emails.messages.account_updated'))
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'action' => config('app.broker_updated'),
