...
trait UserAttribute
{
    ...
    {
        return '<a href="'.route('admin.auth.user.show', $this).'" class="btn btn-info"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.view').'"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.edit', $this).'" class="btn btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.edit').'"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute()
    {
        if ($this->id != auth()->id() && $this->id != 1) {
            return '<a href="'.route('admin.auth.user.destroy', $this).'"
                 data-method="delete"
                 title="' . __('buttons.general.delete') . '"
                 data-trans-button-cancel="'.__('buttons.general.cancel').'"
