@extends('frontend.layouts.front_inner')
...
@section('content')
  ...
  <div class="col-12 mt-3">
    <div id="property_gallery" class="list-unstyled row property-gallery">
      <?php if (!empty($property->images)) { ?>
      <?php foreach ($property->images as $image): ?>
          <?php if (!$image->is_pano) { ?>
            <div class="col col-xs-12" data-responsive="<?php echo Storage::url($image->image_url); ?>" data-src="<?php echo Storage::url($image->image_url); ?>" data-sub-html="<?php echo get_property_title_by_lang($property) ; ?>">
              <?php 
                $cover_image = url('/') . "uploads/images/default_property.jpg";
              ?>
              <img class="img-responsive" src="<?php echo Storage::url($image->image_url); ?>" style="max-width: 100%" alt="">
            </div>
          <?php } ?>
      <?php endforeach; ?>
      <?php } ?>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-xs-12 mt-5">
        ...
        <div class="col-12">
          ...
          <div class="col-12 large-icons my-5">
          <h2 class="weight-light">{{__('strings.frontend.facts')}}</h2>
          <p>
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo url()->current() ; ?>" target="blank"><i class="fa fa-facebook-f"></i></a> 
            <a href="https://twitter.com/home?status=<?php echo url()->current() ; ?>" target="blank"><i class="fa fa-twitter"></i></a>
            <a href="https://plus.google.com/share?url=<?php echo url()->current() ; ?>" target="blank"><i class="fa fa-google-plus"></i></a>
          </p>
        </div>
      ...
      <div class="col-12 my-5">
        ...
        <div class="col-12 my-5" style="border: 1px solid; padding-top: 10px; padding-bottom: 10px;">
          <h2 class="" style='font-size:27px; text-align: center;'>{!! __('strings.frontend.app_download_note') !!}</h2>
          <p class="text-center">
              <a href="#"><img src="<?php echo \Storage::url('/images/android.png')?>" /></a> <br><br>
              <a href="#"><img src="<?php echo \Storage::url('/images/apple-ico.png')?>" /></a>
        </p>
        </div>
