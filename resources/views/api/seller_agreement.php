...
<p style="">
    ...
    <p style="color: black; font-weight: bold; ;"><?php echo strftime('%d %b, %Y %H:%M', strtotime(date('Y-m-d H:iS'))); ?></p>
    <br>
    <br>
    ...
    <br>
    <p style=" font-weight: bold;">SATICININ VEYA VEKİLİNİN</p>
    <p>SATILACAK GAYRİMEKULÜN</p>
    <br>
    <p>ADI-SOYADI: <span style="color:black;"><?php echo $seller->full_name; ?></span></p>
    <p>EV ADRESİ: <span style="color:black;"><?php echo get_address($seller); ?></span></p>
    <p>TELEFON NO: <span style="color:black;"><?php echo $seller->phone_no; ?></span></p>
    <p>CEP TELEFON NO: <span style="color:black;"><?php echo $seller->mobile_no; ?></span></p>
    <ul style="list-style-type: decimal; width:100%;">
        <li>
        ...
        <li>
            <p style="white-space:pre;">Alıcıdan bu satışa mahsuben satıcıya peşinat olarak ödenmiştir. Geriye kalan bedel.7. maddedeki şartlarda açıklandığı gibi ödenecektir.</p>
        </li>
        <li>
          ...
          ?>        
        <li>
            <p>Satıcıdan % <span style="color:black;"><?php echo $commission; ?></span> olmak üzere işbu akdin imzasından itibaren Emlak Komisyoncusuna, tabuda ferağ anında komisyon ücreti olarak ödemeyi taraflar kabul ve taahhüt etmiştir. 
            </p>
        </li>
        <li>
