...
<div class="card">
    <div class="card-body">
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="overview" role="tabpanel" aria-expanded="true">
                        @include('backend.auth.broker.show.tabs.overview')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
        <div class="row"><!--row-->
            <div class="col">
                <a class="btn btn-success" href="{{ route('admin.auth.broker.edit', $user->id) }}">Edit</a>
            </div>
        </div><!--row-->
    </div><!--card-body-->
        ...
        <div class="row">
            <div class="col">
                <small class="float-right text-muted">
                    ...
                    <stron\g>{{ __('labels.backend.access.users.tabs.content.overview.last_updated') }}:</strong> {{ $user->created_at->timezone(get_user_timezone()) }} ({{ $user->updated_at->diffForHumans() }})
                    @if ($user->trashed())
