        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <table id="broker-data-table" class="table table-striped table-bordered">
                        <thead>
                        <tr>
                            <th>{{ __('labels.backend.access.customers.table.customer_no') }}</th>
                            <th>{{ __('labels.backend.access.customers.table.name') }}</th>
                            <th>{{ __('labels.location.city') }}, {{ __('labels.location.district') }}</th>
                            <th>{{ __('strings.frontend.phone') }}</th>
                            <th>{{ __('strings.frontend.mobile') }}</th>
                            <th class="text-center">{{ __('labels.backend.access.customers.table.properties') }}</th>
