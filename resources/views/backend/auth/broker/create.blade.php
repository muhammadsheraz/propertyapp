        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-4 mb-4">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.brokers.default_broker'))->class('col-md-2 form-control-label')->for('is_default') }}

                        <div class="col-md-10">
                            <label class="switch switch-3d switch-primary">
                                {{ html()->checkbox('is_default', false, '1')->class('switch-input') }}
                                <span class="switch-label"></span>
                                <span class="switch-handle"></span>
                            </label>
                        </div><!--col-->
