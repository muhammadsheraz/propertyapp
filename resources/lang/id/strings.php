...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Ini adalah tema PixelUI theme oleh <a href="http://mtpixels.com//" target="_blank">creativeLabs</a>. Ini adalah versi yang dipreteli dengan hanya gaya dan skrip yang diperlukan untuk membuatnya berjalan. Download versi lengkap untuk mulai menambahkan komponen ke dasbor Anda.</p>
