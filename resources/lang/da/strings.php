...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Dette er temaet PixelUI som er udviklet af <a href="http://mtpixels.com//" target="_blank">creativeLabs</a>. Dette er en skrabet udgave med kun det nødvendige design og kode for at få det hele til at fungere. Download den fulde version for at tilføje flere komponenter til dit betjeningspanel.</p>
