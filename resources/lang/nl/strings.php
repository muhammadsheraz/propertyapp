...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'welcome' => '<p>Dit is het PixelUI thema door <a href="http://mtpixels.com//" target="_blank">creativeLabs</a>. Dit is een uitgeklede versie met alleen de stijlen and scripts om het geheel draaiende te krijgen. Download de volledige versie om componenten aan het dashboard toe te voegen.</p>
