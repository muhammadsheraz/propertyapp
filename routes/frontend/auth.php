...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    */
    ...
    Route::group(['middleware' => 'throttle'], function () {
        ...
        Route::get('broker-login', 'LoginController@showLoginForm')->name('login');
        Route::post('login', 'LoginController@login')->name('login.post');

        Route::get('gulumbenim/login', 'LoginBackOfficeController@showLoginForm')->name('backoffice.login');
        Route::post('gulumbenim/login', 'LoginBackOfficeController@login')->name('backoffice.login.post');
